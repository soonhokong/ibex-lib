...
public:
  ...
  ivp_ode(const Function _ydot, double _t0, const IntervalVector _yinit, const Array<NumConstraint>& csp){
      nbvar = _yinit.size();
  ...
  ivp_ode(const Function _ydot, double _t0, const Affine2Vector _yinit_aff, const Array<NumConstraint>& csp){
      nbvar = _yinit_aff.size();
